package HomePage;
	...
	public class RegisterTestPasswordmatch extends BaseClass {
	    ...
	    WebElement passwordvalidation = wutil.waitForElementToBeVisible(driver, rp.getConfirmpasswordMismatchMessage(), 10);
	    
	    System.out.println("panakj"+passwordvalidation.getText());
	    Assert.assertEquals( passwordvalidation.getText(),"The password and confirmation password do not match." , "password is matched");
